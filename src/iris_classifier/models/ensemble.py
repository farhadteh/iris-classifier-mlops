...
class EnsembleModel(BaseModel):
    ...
    def predict_proba(self, X: np.ndarray) -> np.ndarray:
        ...
        for i, model in enumerate(self.models):
            ...
            if model_proba is not None:
                ...
                logger.warning(
                    f"Model {model.name} does not support probability prediction"
                )
    ...
    def evaluate_individual_models(
        ...
        ensemble_metrics = MetricsCalculator.calculate_classification_metrics(
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"EnsembleModel(n_models={len(self.models)}, "
