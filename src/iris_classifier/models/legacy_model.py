...
class ModelManager:
    ...
    def get_latest_model(self, experiment_name: str = "Iris Classification") -> Optional[Any]:
...
class IrisPredictor:
    ...
    def predict_batch(self, data: List[Dict[str, float]]) -> List[Dict[str, Any]]:
        ...
        for i, prediction in enumerate(predictions):
            ...
            if probabilities is not None:
                ...
                result['probabilities'] = {self.class_names[j]: float(prob) for j, prob in enumerate(probs)}
    ...
    def evaluate_model(self, X_test: Optional[np.ndarray] = None, 
