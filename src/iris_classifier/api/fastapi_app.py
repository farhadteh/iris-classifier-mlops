...
def load_model():
    ...
    try:
        ...
        try:
            ...
            model_version_details = client.get_latest_versions(model_name, stages=["None", "Staging", "Production"])
    ...
    try:
        ...
        for i, pred in enumerate(predictions):
            if prob_available:
                ...
                prob_dict = {class_names[j]: float(prob) for j, prob in enumerate(probs)}
