...
class Config:
    ...
    MLFLOW_DEFAULT_ARTIFACT_ROOT: str = os.getenv("MLFLOW_DEFAULT_ARTIFACT_ROOT", "./mlruns")
    ...
    # Model Configuration
    DEFAULT_MODEL_NAME: str = os.getenv("DEFAULT_MODEL_NAME", "iris-logistic_regression")
