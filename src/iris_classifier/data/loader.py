...
class DataLoader:
    ...
    @staticmethod
    def load_from_csv(file_path: str, target_column: str = 'target') -> Tuple[pd.DataFrame, pd.Series]:
        """
        ...
        if target_column not in df.columns:
            logger.warning(f"Target column '{target_column}' not found. Returning full DataFrame and empty Series")
    ...
    @staticmethod
    def create_sample_data(n_samples: int = 100, save_path: Optional[str] = None) -> pd.DataFrame:
        """
