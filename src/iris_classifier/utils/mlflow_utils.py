...
class MLflowManager:
    ...
    def __init__(self, tracking_uri: str = "file:./mlruns", experiment_name: str = "iris_classification"):
        """
    ...
    def log_model_artifacts(self, model, artifact_path: str, signature=None, input_example=None):
    ...
    def search_runs(self, filter_string: str = "", order_by: List[str] = None, max_results: int = 1000):
